...
public class DataAccessFacade implements DataAccess {
	...
	public static final String OUTPUT_DIR = System.getProperty("user.dir") + "/dataaccess/storage"; // for Unix file
	// system
//			+ "\\src\\dataaccess\\storage"; //for Windows file system
	...
	public void editBook(Book book) {
		...
		if (books != null) {
			String bookIsbn = book.getIsbn();
			books.replace(bookIsbn,book);

			saveToStorage(StorageType.BOOKS, books);
		}
	}
	@Override
	public void editAMember(LibraryMember libraryMember) {
		HashMap<String, LibraryMember> lms = readMemberMap();
		if (lms != null) {
			String mId = libraryMember.getMemberId();
			lms.replace(mId,libraryMember);
			saveToStorage(StorageType.MEMBERS, lms);
		}
	}
